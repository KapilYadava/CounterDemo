...
import kotlinx.android.synthetic.main.counter_one_fragment.view.*

class Counter1Fragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        v = View.inflate(context, R.layout.counter_one_fragment, null)
        setUp()
        return v
    }
    private fun setUp(){
